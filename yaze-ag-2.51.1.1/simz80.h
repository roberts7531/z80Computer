...
extern WORD pc;
extern WORD IFF;
extern FASTREG tStates_save;
extern ui32 startTime_save, tStatesInSlice_save;
extern ui32 clockFrequency_save;
extern bool brakeini;
...
typedef FASTWORK (*Core)(FASTREG); /* typedef of the function pointer */

extern Core Z80Core;		   /* funktion pointer for the different
				      simz80 cores */
extern FASTWORK simz80(FASTREG PC);
extern FASTWORK simz80_with_tStates(FASTREG PC);
